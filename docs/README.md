...
Per una guida all'avvio e alla configurazione: [[Introduzione]]
Per i requisiti di sistema: [[Requisiti]]

### Moduli Server (`linux_debian/service/`)

| Modulo                 | Funzione                                               |
| ---------------------- | ------------------------------------------------------ |
| [[ZMQ_data_collector]] | Acquisisce dati dalla macchina DAS via ZeroMQ          |
| [[ssh_file_reader]]    | Scarica dati supplementari dalla macchina DAS ogni 59s |
...
| Modulo            | Funzione                                   |
| ----------------- | ------------------------------------------ |
| [[client_ssh]]    | Scarica i file .h5 dal Server via SSH/SFTP |
| [[netcdf_stitch]] | Aggrega i file da 1s in file da 60s        |

### Moduli di supporto (Client e Server)

| Modulo                 | Funzione                                       |
| ---------------------- | ---------------------------------------------- |
| [[netcdf4_h5_manager]] | Lettura e scrittura file HDF5                  |
| [[yaml_manager]]       | Lettura e scrittura file YAML                  |
| [[script_manager]]     | Gestione processi remoti via SSH               |
| [[timestamp_manager]]  | Persiste l'ultimo timestamp acquisito su disco |
