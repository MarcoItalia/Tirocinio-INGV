...
Usato da [[ZMQ_data_collector]] (scrittura singola), [[netcdf_stitch]] (aggregazione) e [[ssh_file_reader]] (lettura attributi).
...
>     Usato da [[ZMQ_data_collector]] per scrivere ogni pacchetto acquisito.
