...
Usato da [ZMQ_data_collector](../Server/ZMQ_data_collector.md), [ssh_file_reader](../Server/ssh_file_reader.md), [client_ssh](../Client/client_ssh.md), [netcdf_stitch](../Client/netcdf_stitch.md) e [netcdf4_h5_manager](netcdf4_h5_manager.md).
...
> 	Prima di scrivere, converte tutti i valori NumPy in tipi Python nativi tramite `_convert_to_python_vars`. Usato da [ssh_file_reader](../Server/ssh_file_reader.md) per persistere i dati supplementari estratti dalla macchina DAS.
