...
Usato da [[ZMQ_data_collector]], [[ssh_file_reader]], [[client_ssh]], [[netcdf_stitch]] e [[netcdf4_h5_manager]].
...
> 	Prima di scrivere, converte tutti i valori NumPy in tipi Python nativi tramite `_convert_to_python_vars`. Usato da [[ssh_file_reader]] per persistere i dati supplementari estratti dalla macchina DAS.
