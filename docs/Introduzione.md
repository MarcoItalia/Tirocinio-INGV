...
Per una panoramica dei requisiti di sistema vedere [Requisiti](Requisiti.md).
...
3. Lancia il thread [netcdf_stitch](Modules/Client/netcdf_stitch.md) in background
...
| ---------------------- | --------------- | ------------------------------------------- |
| [ZMQ_data_collector](Modules/Server/ZMQ_data_collector.md) | Server          | Acquisisce dati dalla macchina DAS via ZMQ  |
| [ssh_file_reader](Modules/Server/ssh_file_reader.md)    | Server (thread) | Scarica dati supplementari via SSH ogni 59s |
| [timestamp_manager](Modules/Supports/timestamp_manager.md)  | Server          | Persiste l'ultimo timestamp acquisito       |
| [client_ssh](Modules/Client/client_ssh.md)         | Client          | Scarica file .h5 dal Server via SFTP        |
| [netcdf_stitch](Modules/Client/netcdf_stitch.md)      | Client (thread) | Aggrega file da 1s in file da 60s           |
| [netcdf4_h5_manager](Modules/Supports/netcdf4_h5_manager.md) | Client + Server | Lettura/scrittura file HDF5                 |
| [yaml_manager](Modules/Supports/yaml_manager.md)     | Client + Server | Lettura/scrittura file YAML                 |
| [script_manager](Modules/Supports/script_manager.md)     | Client          | Gestione processi remoti via SSH            |
